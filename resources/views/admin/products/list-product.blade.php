                                ...
                                <tbody>
                                    @forelse ($products as $pro)
                                        <tr>
                                            ...
                                            <td>
                                                <ul>
                                                    <li><a href="{{ route('admin.products.show', $pro->id) }}"><i class="ri-eye-line"></i></a></li>
                                                    <li><a href="{{ route('admin.products.edit', $pro->id) }}"><i class="ri-pencil-line"></i></a></li>
                                                    <li><a href="#" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $pro->id }}"><i class="ri-delete-bin-line text-danger"></i></a></li>
                                                </ul>
                                            </td>
                                        </tr>
                                        <!-- Modal Xóa -->
